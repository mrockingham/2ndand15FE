...
Frontend Milestones 0 through 2, 8, 10, and 12 implement the application foundation, authentication lifecycle, team personalization, administrative schedule workspace, editorial CMS, public News, and the public Games schedule described here. Remaining live sports feature directories remain architectural targets.
...
- Public News, editorial administration, and the public schedule/game-detail experience are implemented. Live polling, play-by-play, statistics, predictions, fantasy, and other sports features remain deferred.
...
- Public 2026 preseason and regular-season schedules, resolved game details, Home integration, and favorite-team next-game presentation are implemented. Live polling, play-by-play, statistics, predictions, fantasy, and other sports features remain deferred.
